...
При дистилляции из Qwen3-235B в Qwen3-4B (через промежуточного эксперта Qwen3-14B) получены следующие результаты:
| Подход | Общая точность | Social & Humanities | Natural Science | Math & CS | Other |
| :--- | :---: | :---: | :---: | :---: | :---: |
| **Прямая дистилляция (неразделенная)** | 72.2% | - | - | - | - |
| **CMoE (наш подход)** | **79.3%** | 82.90% | 85.58% | 70.70% | 77.97% |
